    ...
    <div>
      {!videoData ? (
        ...
        <div className="text-richblack-5">
          ...
          <div>
            <button onClick={gotToPrevVideo}>Prev</button>
            <button onClick={handleLectureCompletion}>Play</button>
            <button onClick={gotToNextVideo}>Next</button>
          </div>
          <div>
            <p>{videoData.title}</p>
          ...
          <div>
            <button onClick={handleLectureCompletion}>Add to My Courses</button>
            <button onClick={handleLectureCompletion}>Bookmark</button>
          </div>
        </div>
      )}
    </div>
